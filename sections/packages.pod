...
[Aren't import() and unimport() usually provided by Export when you create a
module?  So, to export from a module, do I actually need to subclass Export or
load its import() method?  Also, If I'm completely wrong, could you explain what
the stock import() and export() methods do.]
