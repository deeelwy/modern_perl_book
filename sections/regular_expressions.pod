...
=head2 The qr// Operator and Regex Combinations
...
Anonymous captures are less frustrating when you evaluate a match in list context:
...
[You should cover the zero-with {negative,positive} look behind assertions.]
