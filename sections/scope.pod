...
Note that the variable is I<visible> within all scopes, but the I<value> of the
...
You I<can> localize functions and methods, but that's deep magic to avoid
unless absolutely necessary.
[Delete this sidebar, or add a sentence or two further explaining it.]
