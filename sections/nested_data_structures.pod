...
=head3 Declaring Nested Data Structures
...
=head3 Accessing Nested Data Structures
...
=head3 Alternatives to Nested Data Structures
...
(L<moose>) will allow you to operate on your data within encapsulation
boundaries.
